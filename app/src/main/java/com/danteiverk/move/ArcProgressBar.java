...
public class ArcProgressBar extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        this.mProgressBarColor = typedArray.getColor(R.styleable.ArcProgressBar_progressbar_color, Color.parseColor("#cc7ed2"));
        this.mProgressbarWidth = typedArray.getDimension(R.styleable.ArcProgressBar_progressbar_width, dipToPx(22));
        ...
        this.mProgressbarUnreachedColor = typedArray.getColor(R.styleable.ArcProgressBar_progressbar_unreached_color, Color.parseColor("#D3D3D3"));
        ...
        setCircleAngle(typedArray.getInteger(R.styleable.ArcProgressBar_max_progressbar_angle, 200));
        typedArray.recycle();
    }
